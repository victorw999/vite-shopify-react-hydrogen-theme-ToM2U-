  ...
  return (
    <div className="section_index_page bg-transparent">
      <h2 className="section_heading_normalcase">
        <b>Best Sellers:</b> Leverage Shopify's <a href="https://shopify.dev/docs/api/storefront"> GraphQL Storefront API </a> to retrieve real-time product data and identify your top-performing items.

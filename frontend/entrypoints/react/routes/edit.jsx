    ...
    <Form method="post" id="contact-form">
      ...
      <p className="form-row">
        <label className="form-row-wrapper">
          ...
          <Input size="xl" type="text" name="twitter" placeholder="@jack" defaultValue={contact.twitter} />
        </label>
      </p>
      <p className="form-row">
        <label className="form-row-wrapper">
      ...
      <p className="form-row">
        <label className="form-row-wrapper">
          ...
          <textarea className=" tw-w-full" name="notes" defaultValue={contact.notes} rows={6} />
        </label>
      </p>
      <p className="form-row">
